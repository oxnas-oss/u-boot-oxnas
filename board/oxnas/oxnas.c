...
int board_init(void)
{
    ...
    *(volatile u32*)SYS_CTRL_GPIO_PRIMSEL_CTRL_0 &= ~0x00400000;

   // *(volatile u32*)((GPIO_1_PA) + 0x14) |= 0x08000000;		// output set
    //*(volatile u32*)(GPIO_1_PA + 0x1c) |= 0x08000000;


    *(volatile u32*)SYS_CTRL_GPIO_PRIMSEL_CTRL_0 &= ~(0x1 << 9);
    *(volatile u32*)SYS_CTRL_GPIO_SECSEL_CTRL_0  &= ~(0x1 << 9);
...
#define MAX_PWMS	16
    ...
    *(volatile u32*)(PWM_DATA_REGISTER_BASE+4*(9 %  MAX_PWMS)) = 50;
    *(volatile u32*)SYS_CTRL_GPIO_PWMSEL_CTRL_0 |= (0x1 << 9);
