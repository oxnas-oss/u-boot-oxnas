...
#define CONFIG_BOOTARGS "console=ttyS0,115200n8 root=/dev/ram0 rw init=/sbin/init initrd=0x4a000000,4M elevator=cfq mem=128M poweroutage=yes mtdparts=physmap-flash.0:128k(uboot),1792k(kernel),1664k(initrd),448k(etc),48k(empty),8k(env1),8k(env2)"
...
#define CONFIG_BOOTDELAY	2
#define CONFIG_BOOTCOMMAND	"cp 0x411e0000 0x4a000000 0x25c000; bootm 0x41020000"

#if defined(NSA210)
#define CONFIG_EXTRA_ENV_SETTINGS \
	"MODEL_ID=D401\0" \
	"PRODUCT_NAME=NSA-210\0" \
	"FEATURE_BIT=00\0" \
	"CONTRY_TYPE=FF\0" \
 ...
 * Networking
 */
#define CONFIG_ETHADDR      00:a0:c5:00:00:0a
...
#define CFG_ENV_ADDR        ((CFG_FLASH_BASE)+0x3FC000)
