...
#define CFG_PROMPT_HUSH_PS2	"N2200> "

/* Miscellaneous configurable options */
#define CFG_LONGHELP				/* undef to save memory		*/
#ifdef CFG_HUSH_PARSER
#define CFG_PROMPT		"N2200$ "		/* Monitor Command Prompt */
#else
#define CFG_PROMPT		"N2200# "		/* Monitor Command Prompt */
#endif
...
#define CONFIG_COMMANDS (SATA_COMMANDS | CFG_CMD_AUTOSCRIPT)
...
#define CONFIG_EXTRA_ENV_SETTINGS					\
	"version="THECUS_VERSION"\0"					\
	"hostname=N2200\0"						\
	"consoledev=ttyS0\0"						\
	"uimageaddr=49000000\0"						\
	"uimagefile=N2200/uImage\0"					\
	"ramdiskaddr=4B000000\0"					\
	"ramdiskfile=N2200/uramdisk\0"					\
        ""

#define CONFIG_FLASHINGCOMMAND						\
	"tftp 4E000000 N2200/flashing.img;"				\
	"autoscr 4E000000"

#define CONFIG_FLASHBOOTCOMMAND						\
	"setenv bootargs root=/dev/ram rw init=/linuxrc mem=256M "	\
	"mac_addr=$ethaddr "						\
	"mac1_addr=$eth1addr "						\
	"console=$consoledev,$baudrate $othbootargs;"			\
	"cp.b 412A0000 $ramdiskaddr 140000;"				\
	"bootm 410E0000 $ramdiskaddr"
...
#define CONFIG_RAMBOOTCOMMAND						\
	...
	"tftp $uimageaddr $uimagefile;"					\
	"bootm $uimageaddr $ramdiskaddr"
 ...
 * Networking
 */
#define CONFIG_ETHADDR      00:50:8D:30:FF:B2
#define CONFIG_ETH1ADDR     00:50:8D:30:FF:B3
#define CONFIG_NETMASK      255.255.255.0
#define CONFIG_IPADDR       172.16.88.220
#define CONFIG_SERVERIP     172.16.88.222
#define CONFIG_GATEWAYIP    172.16.88.222
//#define CONFIG_BOOTFILE     N2200/uImage
...
#define CFG_ENV_ADDR        ((CFG_FLASH_BASE)+0x3e0000)
